...
class Column {
    ...
    /** Return my specified name. */
    String specifiedName() {
        return _specifiedName;
    }

    /** Set my _specifiedName to NAME. */
    ...
    /** My specified name (i.e. for "X.Y as Z" during a select clause,
     *  my selected name is Z). If no name is specified, then specified name
     *  is set to _columnName. */
